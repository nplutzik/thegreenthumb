...
User.create!([
  {email: "a@b.c", password: "12345678", encrypted_password: "$2a$10$yZFRWUf6VpK96mPro8Ub9.rdr1PCQPLcNvU4yEfB0xWq0zjow49My", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 2, current_sign_in_at: "2014-05-15 22:51:45", last_sign_in_at: "2014-05-15 20:34:49", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", first_name: "a", last_name: "b", avatar: nil, is_closed: nil, is_admin: true, address: "nr abc mall"},
  {email: "d@e.c", password: "12345678", encrypted_password: "$2a$10$PeKCxjfAQk52itY51GyNxOlmL17T9g0oUM.tDbUltDANMA565WGYu", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 1, current_sign_in_at: "2014-05-15 21:10:10", last_sign_in_at: "2014-05-15 21:10:10", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", first_name: "d", last_name: "e", avatar: nil, is_closed: nil, is_admin: nil, address: "nr abc mall"}
])
Category.create!([
  {name: "APPLIANCES"},
  {name: "BATH"},
